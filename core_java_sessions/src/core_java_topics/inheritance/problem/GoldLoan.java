...
public class GoldLoan {
	...
	private String gold_loan_feature;
	...
	public String getGold_loan_feature() {
		return gold_loan_feature;
	}
	public void setGold_loan_feature(String gold_loan_feature) {
		this.gold_loan_feature = gold_loan_feature;
	}
	@Override
	public String toString() {
		return "GoldLoan [loan_number=" + loan_number + ", loan_applicant_name=" + loan_applicant_name
				+ ", loan_disbursed_date=" + loan_disbursed_date + ", mailing_address=" + mailing_address
				+ ", loan_amount=" + loan_amount + ", roi_interest=" + roi_interest + ", gold_loan_feature="
				+ gold_loan_feature + "]";
	}
}
