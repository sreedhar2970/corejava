package Project_on_types_of_object_using_clone_method;


public class BusinessAdvantagePlusRelationshipAccountDetails {

	public static void main(String[] args) {
		try {
			BusinessAdvantagePlusRelationshipAccount account1 = new BusinessAdvantagePlusRelationshipAccount();
			...
			BusinessAdvantagePlusRelationshipAccount account2 = (BusinessAdvantagePlusRelationshipAccount) account1.clone();
